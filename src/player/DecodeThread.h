...
public:
     ...
     *
     * @param decoder - The audio decoder to read from (must outlive this object)
     ...
     */
    void start(IAudioDecoder* decoder, RingBuffer<int16_t>* ringBuffer, std::size_t chunkFrames = 1152);
    void stop();
...
private:
    ...
    IAudioDecoder* decoder_;           // Not owned
